...
>
> Ultimo aggiornamento: 8 settembre 2026, sera (ridisegno completo).
>
> **Indirizzo cambiato l'8/09/2026**: l'app ora vive su
> **https://travi-738.pages.dev** (prima era su GitHub Pages). Se l'icona sul
> telefono apre ancora l'indirizzo vecchio, va tolta e reinstallata da questo
> nuovo indirizzo (Safari → Condividi → Aggiungi a Home) — un'icona già
> installata resta legata al dominio da cui è nata, un cambio di hosting non
> la aggiorna da solo. Dettagli in IDEE-FUTURE.md.
...
## 17. Il ridisegno (8/09/2026) — da provare tutto insieme

> Prima di cominciare: **chiudi del tutto l'app e riaprila**. La cache è alla
> v26 e i nomi delle immagini non sono cambiati — se non ricarica, continui a
> vedere le vecchie foto.

### 17.1 Colori e rilievo (strato 1)
- [ ] Il fondo è **sabbia calda** (#F0E8DC), non più bianco-grigio freddo.
- [ ] I gruppi e le schede **sporgono** dalla pagina: si vede l'ombra in basso
      a destra e un filo di luce in alto a sinistra. Sono i valori che hai
      tarato tu su `/rilievo`.
- [ ] In Altro **non c'è più nessun riquadro verde**.
- [ ] La voce attiva nella pillola di navigazione è **corallo pieno**.

### 17.2 Altro (strato 2)
- [ ] Le voci non sono più schede separate: ogni sezione è **un blocco solo**
      con le righe divise da un filo sottile.
- [ ] Il budget è un **blocco nero** col numero grande e il cambio yen a lato.
- [ ] Le icone (frasi, cambio, diario, uscita, prenotazioni) sono tutte
      **monocrome**, nessuna colorata.

### 17.3 Home (strato 2)
- [ ] In alto: riga piccola col conto alla rovescia, poi **"Giappone"** grande.
- [ ] Il meteo è una **goccia appoggiata allo sfondo**, senza riquadro, con
      dentro l'illustrazione del Fuji.
- [ ] Il numero della temperatura **non c'è** ed è giusto così: Open-Meteo dà
      previsioni solo a ~15 giorni e al viaggio ne mancano 239. In Giappone ci
      sarà.
- [ ] Il Budget **non c'è più in Home** (era lo stesso numero che sta in Altro).
- [ ] Si vedono gli **aloni sfumati**: arancio in alto, ardesia in basso. Non
      devono avere bordi netti da nessuna parte — se vedi una riga dritta dove
      finisce il colore, dimmelo.

### 17.4 Itinerario (strato 3) — la parte più cambiata
- [ ] Le pillole dei giorni sono **allungate** e sporgono; il giorno scelto è
      arancione e **sprofonda** invece di sporgere.
- [ ] Tenendo il dito premuto su un altro giorno, **anche quello affonda** per
      un attimo.
- [ ] Le tappe non sono più righe con la miniatura: sono **tessere** con
      l'illustrazione a tutta larghezza.
- [ ] **L'altezza della tessera è la durata**: una tappa da 45 minuti è
      visibilmente più bassa di una da due ore. È il controllo più importante
      di tutti — guarda una giornata piena e dimmi se la forma "si legge".
- [ ] Fra una tessera e l'altra ci sono **fili sottili** con lo spostamento
      ("20 min di metro") e il tempo libero ("30 min liberi"), non blocchi.
- [ ] Segnando una tappa come fatta col tondo in alto a sinistra, la tessera
      **perde l'illustrazione e affonda** nella pagina.
- [ ] **Controllo importante**: apri più giorni diversi. Le fasce arancioni di
      avviso devono comparire SOLO dove il motore trova un problema vero, non
      su tutte le tappe di tutti i giorni. Prima era così ed era un bug: il
      motore valutava ogni giorno futuro partendo dall'ora in cui stavi
      guardando il telefono.

### 17.5 Le illustrazioni (strato 4)
- [ ] Tutte e 28 le immagini sono illustrazioni, nessuna foto.
- [ ] Le luci sono **diverse fra loro**: Akihabara e Dotonbori di notte,
      Arashiyama e Kenrokuen verdi, Hakone nella foschia, Miyajima al tramonto,
      Ueno rosa di primavera, il memoriale di Hiroshima grigio e quieto.
- [ ] Il testo bianco sulle tessere è **leggibile su tutte**, anche su quelle
      chiare (Hakone, il volo, il Fuji). Se su qualcuna fatichi, segnala quale.
- [ ] Le quattro generiche (trasferimento, hotel, volo, cibo) sono più quiete
      delle altre: il trasferimento compare 12 volte su 52.
